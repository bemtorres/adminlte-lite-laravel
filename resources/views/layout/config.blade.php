<aside class="main-sidebar">
  <section class="sidebar">
    <div class="user-panel">
      ...
      <p>Benjamin</p>
        <a href="home.php"><i class="fa fa-circle text-success"></i> Administrador</a>
      </div>
    </div>
    <ul class="sidebar-menu" data-widget="tree">
      ...
      {{-- <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="reporte-visita-historial.php"><i class="fa fa-bar-chart"></i>Visitas Realizadas</a></li>
          <li class="active"><a href="reporte-visita-tec-historial.php"><i class="fa fa-bar-chart"></i>Visitas Tecnico Realizadas</a></li>
       </ul>
      </li>
      <li class="treeview">
        <a href="home.php">
