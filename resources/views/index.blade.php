...
<div class="login-box">
  <div class="login-logo">
    <img src="/img/cl.png" class="hidden-sm hidden-xs" alt="img" width="150" height="100">
  ...
  <div class="login-box-body">
    ...
    <form class="form-signin" action="login" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Contraseña" autocomplete="off" name="txtClave" required>
      ...
      <div class="row">
        ...
        <br>
        <div class="col-md-12">
          <a href="/recuperar" class="">Recurperar Contraseña</a>
        </div>
      </div> 
    </form>   
    <br>
